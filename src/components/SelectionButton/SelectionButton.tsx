...
const SelectionButton = ({dataOption, children}: props) => {
  ...
  return (
    <div className='selection-button relative w-[266px]  rounded-[10px] border-[1px] bg-[#fff] border-[#E5E5EA]'>
        ...
        <div className={`option-list w-full bg-[#fff] left-0 absolute top-[105%] rounded-[5px] border-[1px] border-[#E5E5EA] ${optionMound ? 'scale-1 opacity-1' : 'scale-0 opacity-0'} transition-all origin-top`}>
